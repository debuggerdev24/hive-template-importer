-- Supabase / PostgreSQL Schema for Hive Inspect Template System
-- Direct executable SQL script for Supabase SQL Editor or psql
...
CREATE TABLE IF NOT EXISTS templates (
  ...
  name TEXT NOT NULL,
  description TEXT,
  original_source TEXT DEFAULT 'manual',
